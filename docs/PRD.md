...
This document captures the product requirements, architecture, folder conventions, API surface, cache strategy, AI integration, milestone plan, and implementation checklist for **mrgb-chat** — a personal ChatGPT-like app built with:
...
Agent workflow, branch/commit rules, quality gates, and session bootstrap live in [`AGENTS.md`](../AGENTS.md). This file is product and architecture context only.
